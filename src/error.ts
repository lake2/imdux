export const notInitialized = "[Imdux] Do not call Action.query or Action.dispatch before initializing it using createStore.";
export const wrongModify = "[Imdux] Do not modify value of store directly, use dispatch instead.";
export const payloadNotValid = "[Imdux] Payload should always be a plain object or a primitive type value, other value will be replace as undefined. " +
